  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-foreground">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 text-center">
        <div className="inline-block px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
        ...
        <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6 animate-fade-in-up" style={{ animationDelay: "0.2s", opacity: 0 }}>
          <span className="text-background">Akash </span>
          <span className="text-gradient">Vaddapelli</span>
        </h1>
        <p className="max-w-2xl mx-auto text-background/60 leading-relaxed mb-10 animate-fade-in-up text-lg" style={{ animationDelay: "0.5s", opacity: 0 }}>
