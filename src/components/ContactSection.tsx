      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-4">
              {socials.map((s) => (
                <a
                  ...
                  className="group flex items-center gap-4 p-4 rounded-xl border border-border bg-card hover:border-primary/40 hover:-translate-y-0.5 transition-all duration-300 border-glow"
                >
                  <div className="w-12 h-12 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center group-hover:bg-primary group-hover:glow-green-strong group-hover:scale-110 transition-all duration-300">
                    <s.icon className="text-primary group-hover:text-primary-foreground transition-colors duration-300" size={22} />
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground font-display font-bold uppercase tracking-widest">{s.label}</p>
          ...
          <div className="relative group/form">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-primary/15 via-transparent to-primary/15 rounded-2xl blur opacity-0 group-hover/form:opacity-100 transition-opacity duration-500" />

            <form
              onSubmit={handleSubmit}
              className="relative space-y-5 bg-card border border-border rounded-2xl p-7 hover:border-primary/20 transition-all duration-500 border-glow"
            >
              <div>
                <Input
                  ...
                  className="border-border bg-background focus:border-primary focus:ring-primary/20 rounded-xl h-12 transition-all duration-300 font-body"
                />
              ...
              <div>
                <Textarea
                  ...
                  className="border-border bg-background focus:border-primary focus:ring-primary/20 resize-none rounded-xl transition-all duration-300 font-body"
                />
              ...
              <Button
                ...
                type="submit"
                disabled={sending}
                className="w-full bg-primary text-primary-foreground hover:bg-primary/90 glow-green hover:glow-green-strong hover:scale-[1.02] transition-all duration-300 rounded-xl h-12 font-display tracking-wider"
              >
                {sending ? (
